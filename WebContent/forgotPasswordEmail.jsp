...
<title>Mr.Mason | ForgotPassword</title>
<!-- Base Css -->
								...
								<div class="auctionMainForm col-md-10 col-xs-12">
									...
									<form  name="sellfrm" id="sellfrm"
										...
										<div class="aucformFieldsBox">
										    ...
										    <label style="width: 100%;font-size: 17px;color: #020202; font-family: sans-serif;">Email Address/Mobile No. <span style="color: red">*</span></label>	
											<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-user"></i></span>
											 <input class="form-control" type="text" placeholder="Enter Email Address/Mobile No." name="email" required>
										    </div>
										    </div>
										    </div>
											...
											<br>
											<h4>										
										    <input class="btn" type="submit" value="FORGOT PASSWORD" style=" width: 100px;
