...
<head>
     ...
     <!--============================ new section ============================ -->  
        ...
        <!--===============  slider section ======================= -->
           ...
           <c:forEach var="cd" items="${tilesDetails}" >
           <!-- ======= start====== -->
           ...
           <input type="checkbox" title="Add to Cart" name="vehicle" onchange="addtocart(this.value)" value="${cd.SEQ_ID}" class="bo2">
          ...
          <div class="clearfix"> </div>
           ...
           <%-- <div class="col-md-12 box2">
            <c:set var="cementtype" value="${cd.TILES_TYPE}" scope="request"/>
           ...
           <div class="col-md-12 box2">
          <span class="bo">Nominal Size :</span><span class="bo1">${cd.NOMINAL_SIZE}</span>
           </div>
           <div class="col-md-12 box2">
          <span class="bo">Length :</span><span class="bo1">${cd.LENGTH}</span>
           </div>
           
           <div class="col-md-12 box2">
          <span class="bo">Width :</span><span class="bo1">${cd.WIDTH}</span>
           </div>
           <div class="col-md-12 box2">
          <span class="bo">Thickness :</span><span class="bo1">${cd.THICKNESS}</span>
           </div>
           <%-- 
           <div class="col-md-12 box2">
