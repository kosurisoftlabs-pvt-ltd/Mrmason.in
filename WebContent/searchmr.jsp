...
<head>
     ...
     <!--============================ new section ============================ -->  
        ...
        <!--===============  slider section ======================= -->
					...
					<option value="2,">Asianpaints</option>
					<option value="4,">Bergerpaints</option>
					</select>
					</div>
				   ...
				   <option style="display: none;" value="SELECT">Type</option>
	                ...
	                <option value="HORN">Apex</option>
	                <option value="Lubricants">Apex</option>
	                <option value="spare  parts">Apex</option>
	                <option value="Spare Parts">Apex</option>
                    </select>
           ...
           <input type="checkbox" title="Add to Cart" name="vehicle" onchange="addtocart(this.value)" value="${pd.PAINTS_SEQ_ID}" class="bo2">
          ...
          <span class="bo">Quality :</span><span class="bo1">${pd.SPECIAL_NAME}</span>
           ...
           <div class="col-md-12 box2">
           <span class="bo">Color Group :</span><span class="bo1">${pd.AVAILABLE_COLORS }</span>
           </div>
