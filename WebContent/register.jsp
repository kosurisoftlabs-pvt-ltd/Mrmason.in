					...
					<section class="sellUcarpg">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12">
							<div class="auctionFormRight" style="margin-top: 0px;">
								...
								<div class="auctionMainForm col-md-10 col-xs-12" style="padding:0 0px;">
									    <form name="sellfrm" id="sellfrm" method="POST" action="./RegisterUser" onSubmit="return validate()">
											...
											Register Here Plan Your Land Mr.Mason</h2>
									      ...
									      <!--============ first section ===========-->
									       <div id="">
								            ...
								            <div class="col-md-8">
								             ...
								             <form id='form-id'>
								             <input id='watch-me' name='test' type='radio' checked /> <span class="rer">Business Owner &nbsp; </span>
								             <input id='see-me' name='test' type='radio' /> <span class="rer">Individual Owner</span>
								             </form>
								            
								             
								              <div id='show-me' style="padding: 0 0; margin: 4px 0;">
                                              ...
                                              <div id='show-me-two' style="display:none; padding: 0 0; margin: 4px 0;">
                                                <div class="input-group" id="bo1">
											    <input type="checkbox" name="usertype" value="I" id="bo2">  Individual <br>
								                </div>
                                              </div>
