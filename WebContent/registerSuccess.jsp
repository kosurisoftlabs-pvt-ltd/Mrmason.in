	   ...
	   <!--============================ user type ================================-->
									      ...
									      <!--============ first section ===========-->
									       ...
									       <div id="demo" class="collapse">
								            ...
								            <input type="text" name="otp" class="form-control" id="" value="" placeholder="Enter Your Mobile Otp No"
						                    pattern="[1-9]{1}[0-9]{9}" title="Enter 6 pincode number" maxlength="6" required>
								            </div></div>
								            </div>
								            </div>
											</div>
