            ...
            <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
			     ...
			     <!--=========== form section =============-->
					   ...
					   <form name="form" action="./AddBrand" method="post" onsubmit="return validation()">
						 ...
						 <button type="submit" class="btn btn-info btn-block" name="sub"  id="box"> Add Brand </button>
						 </div>
						 </div>
						 </form> 
						 </div>
