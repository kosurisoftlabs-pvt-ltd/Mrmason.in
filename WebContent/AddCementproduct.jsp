            ...
            <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
                   <div class="content-page">
                       ...
                       <!--=============== top section ================-->
                        ...
                        <h4 class="page-title float-left">Add Cement Details</h4>
                      ...
                      <!--==================  body section =================--> 
						...
						<form action="./AddCementProduct" name="form" method="post" onsubmit="return validation()" enctype="multipart/form-data" >
						 <div class="row">
						<%  
						 String catid="";
						 ...
						 for(int i =0;i<al.size();i++)
							{
								...
								if(cat.getCATEGORY().equalsIgnoreCase("cement"))
								{
						 ...
						 ArrayList<Subcategory> sal=new CategoryService().viewAllSubCategory(catid);
						   ...
						   %> 
							...
							<input type="text" class="form1" name="productcategory" id="productcategory" value="Cement" readonly="readonly">
						...
						<div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Cement Type :</label>
                         <select class="form1" name="cementtype" id="cementtype">
                         <option value="OPC">OPC ( Concrete Works)</option>
                         <option value="PPC">PPC ( Brick & Plasting Works)</option>
                         <option value="W">WHITE ( Tiles & Marble Works)</option>
                         </select>
                         </div>
                         <div class="form-group col-md-6 col-sm-6">
                         ...
                         <input type="text" class="form1" name="skuid" id="skuid" placeholder="SKUID" required="required">
                          ...
                          <div class="form-group col-md-6 col-sm-6">
						    <label for="pincode">Mass:</label>
						    <select name="mass" class="form1">
						    <option>Bags</option>
					    ...
					    <textarea class="form2" name="description" id="description" cols="" rows=""></textarea> 
						 ...
						 <button type="submit" class="btn btn-info btn-block" name="sub"  id="box"> ADD CEMENT </button>
						 </div>
