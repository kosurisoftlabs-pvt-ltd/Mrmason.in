            ...
            <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
                   <div class="content-page">
                       ...
                       <!--=============== top section ================-->
                        ...
                        <h4 class="page-title float-left">Add Tiles Details</h4>
                      ...
                      <!--==================  body section =================--> 
						...
						<form action="./AddTilesDetails" name="form" method="post" onsubmit="return validation()" enctype="multipart/form-data" >
						 <div class="row">
						 <%  
						 String catid="";
						 ...
						 for(int i =0;i<al.size();i++)
							{
								...
								if(cat.getCATEGORY().equalsIgnoreCase("Tiles"))
								{
								 catid = String.valueOf(cat.getCAT_ID());
								}
							}
						  
						 ArrayList<Subcategory> sal=new CategoryService().viewAllSubCategory(catid);
						  
						   %> 
						   	<div class="form-group col-md-6 col-sm-6">
							<label for="email">Product Category :</label>
							<input type="text" class="form1" name="productcategory" id="productcategory" value="Tiles" readonly="readonly">
							<input type="hidden" class="form1" name="categoryid" id="categoryid" value="<%=catid %>" readonly="readonly">
						 </div>
                         ...
                         <select class="form1" id="subcategory" name="subcategory">
								...
								{
									Subcategory cat=sal.get(i);
								%>
								<option value="<%=cat.getMat_subcat_seq_id()%>"><%=cat.getSUBCATEGORY()%></option>	
								<%}
								%> 
							</select>
						...
						<!--  <div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Tiles Type :</label>
                         <select class="form1" name="tilestype" id="tilestype">
                         <option></option>
                         <option></option>
                         <option></option>
                         <option></option>
						 ...
						 <div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Nominal Size (in cm) :</label>
                         <input type="text" class="form1" name="nominalSize" id="nominalSize" placeholder="15 cm" required="required">
                         </div>
						 
						<div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Tiles Length (in mm) :</label>
                         <input type="text" class="form1" name="length" id="length" placeholder="10 mm" required="required">
                         </div>
                         
                         <div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Tiles Width (in mm) :</label>
                         <input type="text" class="form1" name="width" id="width" placeholder="8 mm" required="required">
                         </div>
                         
                         <div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Thickness (in mm) :</label>
                         <input type="text" class="form1" name="thickness" id="thickness" placeholder="2 mm" required="required">
                         </div>
					    ...
					    <textarea class="form2" name="description" id="description" cols="" rows=""></textarea> 
					    </div>
					    </div>
						 ...
						 <button type="submit" class="btn btn-info btn-block" name="sub"  id="box"> ADD TILES </button>
						 </div>
