            ...
            <jsp:include page="./usersidebar.jsp"></jsp:include>
                   <div class="content-page">
                       ...
                       <!--=============== top section ================-->
                        ...
                        <h4 class="page-title float-left">Manufacturer</h4>
                      ...
                      <!--=============== end top section ================-->
						...
						<form name="form" action="./AddNewBusiness" method="post" onsubmit="return validation()">
						   <span class="bo">Business Details<br><br>
                           ...
                           <input type="text" class="form1" name="businessType" id="businessType" value="Manufacturer" readonly="readonly">
                           </div>
                           <div class="form-group col-md-6 col-sm-6">
						   ...
						   <div class="row">
                            ...
                            <input type="text" class="form1" name="gstno" id="gstno" placeholder="Enter Your Gst No">
                            </div>
						 ...
						 <div class="row">
                          ...
                          <input type="text" class="form1" name="pincode" id="pincode" placeholder="Enter Your Pincode">
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">D.No</label>
                          <input type="text" class="form1" name="dno" id="dno" placeholder="Enter Your D.No">
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">Street</label>
                          <input type="text" class="form1" name="street" id="street" placeholder="Enter Your Street">
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">Landmark <span style="color:red;font-size:21px;">*</span></label>
                          <input type="text" class="form1" name="Landmark" id="Landmark" placeholder="Enter Your Landmark">
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">City <span style="color:red;font-size:21px;">*</span></label>
                          <input type="text" class="form1" name="city" id="city" placeholder="Enter Your City">
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">State <span style="color:red;font-size:21px;">*</span></label>
                          <input type="text" class="form1" name="state" id="state" placeholder="Enter Your State">
                          </div>
