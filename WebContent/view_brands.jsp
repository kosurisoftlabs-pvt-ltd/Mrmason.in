            ...
            <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
                   <div class="content-page">
                       ...
                       <!--=============== top section ================-->
                        ...
                        <h4 class="page-title float-left">View Brand</h4>
                ...
                <!--  =========== table section =============	 -->
        			...
        			<tr>
        				<th class="numeric">Brand ID</th>
        				<th class="numeric">Brand Name</th>
        			</tr>
        		    </thead>
        		    <tbody>
        		    <c:forEach var="brand" items="${branddetails}">
        			<tr>
        				<td data-title="Product Name" class="numeric">${brand.BRAND_SEQ_ID}</td>
        				<td data-title="Material Name" class="numeric">${brand.BRAND_NAME}</td>
        			</tr>
        			</c:forEach>
					</tbody>
					</table>
