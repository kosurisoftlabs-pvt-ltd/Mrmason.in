                   ...
                   <div class="content-page">
                      ...
                      <!--=============== end top section ================-->
						...
						<form name="form" action="./AddNewBusiness"  method="post" onsubmit="return validation()">
						   ...
						   <%if(request.getAttribute("message")!=null){out.println(request.getAttribute("message"));} %></span>
						   <div class="form-group col-md-12 col-sm-12"></div>
						   <div class="row">
						   <div class="form-group col-md-6 col-sm-6">
                           <label for="pincode">Business Type :</label>
                           <input type="text" class="form1" name="businessType" id="businessType" value="Distributor" readonly="readonly">
                           </div>
                           </div>
						   <div class="row">
							<div class="form-group col-md-6 col-sm-6">
