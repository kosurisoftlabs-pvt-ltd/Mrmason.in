            ...
            <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
                   <div class="content-page">
                       ...
                       <!--=============== top section ================-->
                        ...
                        <h4 class="page-title float-left">View Sub Category</h4>
			     ...
			     <!--=========== form section =============-->
						<div class="col-xl-12 col-sm-12">
						 <span class="bo">View Sub Category</span>
                ...
                <!--  =========== table section =============	 -->
        			...
        			<tr>
        				...
        				<td data-title="Qualification" class="numeric">${category.SUBCATEGORY}</td>
        			</tr>
        			</c:forEach>
					</tbody>
					</table>
