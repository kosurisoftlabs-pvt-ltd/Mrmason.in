...
<head>
   ...
   <body>
        <!-- Begin page -->
             <div id="wrapper">
            <jsp:include page="./individual_top.jsp"></jsp:include>
            <jsp:include page="./individual_sidebar.jsp"></jsp:include>
			  ...
			  <!--=========== form section =============-->
						<div class="col-xl-9 col-sm-9">
                         ...
                         <input type="text" class="form1" name="email" id="email" value="${userdetails.emailId}" readonly="readonly">
                         ...
                         <input type="text" value="${userdetails.mobileNo}" class="form1" name="mobile" id="mobile" readonly="readonly">
