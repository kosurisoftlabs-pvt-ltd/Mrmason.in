             ...
             <jsp:include page="./dashboardSidebar.jsp"></jsp:include>
                 ...
                 <!--=========== table section =============-->	
        			...
        			<tr>
        				...
        				<th class="numeric">Available Colors</th>
        			...
        			<td data-title="SKU ID" class="numeric">
        				<form action="./getAPaintsIndividualDetails" method="post">
        				...
        				<td data-title="Material Name" class="numeric">
        				...
        				<td data-title="Available Colors" class="numeric">${pd.AVAILABLE_COLORS}</td>
        				<c:set var="category1" value="${pd.CATEGORY}" scope="request"/>
        				<c:set var="subcategory1" value="${pd.SUBCATEGORY}" scope="request"/>
        				<td data-title="Category" class="numeric"><%=chm.get(request.getAttribute("category1")) %></td>
        				<td data-title="SubCategory" class="numeric"><%=schm.get(request.getAttribute("subcategory1")) %></td>
        			</tr>
        			</c:forEach>
					<%}
        		    %>
					...
					<table>
							...
							<c:forEach begin="1" end="${numofpages}" var="i">
									<td class="two">
						<form action="./GetASPMaterials" method="get">
        				  <input type="hidden" name="productcategory" value="<%=request.getParameter("productcategory")%>">
        				  <input type="hidden" name="subcategory" value="<%=request.getParameter("subcategory")%>">
        				  <input type="hidden" name="brand" value="<%=request.getParameter("brand")%>">
        				  ...
        				  <button type="submit" class="btn btn-link"><c:out value="${i}"/></button>
									...
									<%-- <a href="./GetASPMaterials?page=${i}&productcategory=<%=request.getParameter("productcategory")%>&subcategory=<%=request.getParameter("subcategory")%>&brand=<%=request.getParameter("brand")%>">${i}</a> --%>
							</td>
							</c:forEach>
							</tr>
						  </table>
