             ...
             <jsp:include page="./usersidebar.jsp"></jsp:include>
                   <div class="content-page">
                      ...
                      <!--==================  body section =================--> 
					    ...
					    <form action="./GetSPMaterialsDetails" method="post">
						...
						<form action="./PaintMaterialUpdate" name="form" method="post" onsubmit="return validation()">
						...
						<input type="hidden" name="status" value="${paintDetails.STATUS}">
						<%
                         ...
                         <input type="text" class="form1" name="interexter" id="interexter" value="${paintDetails.INTER_EXTER}" placeholder="Interior/Exterior" required="required">
                         </div>
						 
						 <div class="form-group col-md-6 col-sm-6">
                         <label for="pincode">Weight :</label>
                         <input type="text" class="form1" name="weight" id="weight"value="${paintDetails.WEIGHT}" placeholder="Weight : 100 grms" required="required">
                         </div>
