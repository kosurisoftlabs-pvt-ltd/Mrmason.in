<%@ page language="java" import="com.mason.utils.*,com.mason.bean.*" contentType="text/html; charset=ISO-8859-1"
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12   res"  style="position: relative;top: 40px;">
							...
							<div class="col-md-1 col-xs-12"></div>
								...
								<div  class="auctionMainForm col-md-10 col-xs-12">
									...
									{
										sr=(ServiceRequest)request.getAttribute("servicerequest");
    								...
    								%>
             			 			...
             			 			<%}%>
									<h2 class="aucformTitle text-center"><%= message %></h2>
									 
									<form align="center" name="sellfrm" id="sellfrm"
										 action="./ServiceRequestLogin" method="post" autocomplete="off">
                                         ...
                                         <div align="center">
											...
											<input class="form-control" type="hidden" name="pincode1" value="<%=sr.getREQ_PINCODE()%>">
											<input class="form-control" type="hidden" name="service" value="<%=sr.getSERVICE_NAME()%>">
											<input class="form-control" type="hidden" name="description" value="<%=sr.getDESCRIPTION()%>">
											<input class="form-control" type="hidden" name=reqDate" value="<%=sr.getSERVICE_DATE()%>">
										...
										&nbsp; 
									    <a href="./ServiceRequesterRegister.jsp" style="color: #18aedf; font-weight: 500;font-size: 17px;"><u>Register</u></a></span>
										<br><br>
                               			</div>
                               			</div>
									</form>
