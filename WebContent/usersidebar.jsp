   ...
   <body>
        ...
        <div id="wrapper">
           ...
           <!-- ========== Left Sidebar Start ========== -->
				...
				<li class="menu-title">User Dashboard</li>
				<!--<li>
				...
				<li>
				<a href="user_dashboard.jsp"><i class="fi-air-play"></i><span>Dashboard</span></a>
				</li>      
				<li>
				...
				<ul class="nav-second-level" aria-expanded="false">
				<li><a href="user_manufacturer.jsp">Manufacturer</a></li>
				<li><a href="user_distributor.jsp">Distributor</a></li>
				<li><a href="user_dealer.jsp">Dealer</a></li>
				<li><a href="user_retailer.jsp">Retailer</a></li>
				</ul>
				</li> -->
				<li>
				<a href="javascript: void(0);"><i class="fa fa-plus-square"></i><span>Add New Service </span> <span class="menu-arrow"></span></a>
				<ul class="nav-second-level" aria-expanded="false">
				<li><a href="user_addmyservice.jsp">Add My Service</a></li>
				<li><a href="usermyservices.jsp">View My Services</a></li>
				</ul>
				</li>
				<!-- <li>
				<a href="javascript: void(0);"><i class="fa fa-bar-chart"></i><span>Material Management </span> <span class="menu-arrow"></span></a>
				<ul class="nav-second-level" aria-expanded="false">
				<li><a href="user_addproduct.jsp">Add Product</a></li>
				<li><a href="./user_addproductBulkUpload.jsp">Upload form Excel Sheet</a></li>
				<li><a href="./viewSPMaterial.jsp">Update Product</a></li>user_update_product.jsp
				<li><a href="user_deactivate_delectproduct.jsp">Deactivate/Delete Product</a></li>
				<li><a href="user_request_newcategory.jsp">Request for New Category</a></li>
				<li><a href="user_updatepricesubmit.jsp">Update Price&Submit </a></li>
				</ul>
				</li> -->
				<li>
				<a href="javascript: void(0);"><i class="fa fa-cogs"></i><span>Service Management</span> <span class="menu-arrow"></span></a>
				<ul class="nav-second-level" aria-expanded="false">
				<<!-- li><a href="user_service_management.jsp">Service Management</a></li>
				<li><a href="./SP_MyServices">My Services</a></li> -->
				<li><a href="user_add_service_person.jsp">Add Service Person</a></li>
				<li><a href="./View_Service_Persons">Edit Service Person</a></li>
				<li><a href="./UNewRequests">New Requests</a></li>
				</ul>
				</li>
				<!-- <li>
				<a href="javascript: void(0);"><i class="fa fa-quote-right"></i><span>Quotation Management </span> <span class="menu-arrow"></span></a>
				<ul class="nav-second-level" aria-expanded="false">
				<li><a href="user_newquotations.jsp">New Quotations</a></li>
				<li><a href="user_updatequotation.jsp">Update Quotations</a></li>
				<li><a href="user_approved_quotations.jsp">Approved Quotations</a></li>
				</ul>
				</li>
				<li>
				<a href="javascript: void(0);"><i class="fa fa-registered"></i><span>Request for Management </span> <span class="menu-arrow"></span></a>
				<ul class="nav-second-level" aria-expanded="false">
				<li><a href="user_updateprice.jsp">Update Price&Submit </a></li>
				</ul>
				</li> -->
