...
<link href="assets/css/register-page.css" rel="stylesheet"
	...
	<div id="page-content">
	   ...
	   <!--============================ user type ================================-->
									      ...
									      <!--============ first section ===========-->
									      <%if(message.equals("M")) {%>
									       <form name="sellfrm" id="sellfrm" method="post" action="./ValidateOTPReset" onSubmit="return validate()">
									       ...
									       Please validate your OTP <a href="#" data-toggle="collapse" data-target="#demo" 
