                   ...
                   <div class="content-page">
                      ...
                      <!--=============== end top section ================-->
						...
						<form name="form" method="post" onsubmit="return validation()">
						   <span class="bo">Business Details :</span>
						   <div class="form-group col-md-12 col-sm-12"></div>
						   <div class="row">
						   <div class="form-group col-md-6 col-sm-6">
                           <label for="pincode">Business Type :</label>
                           <input type="text" class="form1" name="business type" id="business type" placeholder="Enter Your Business Type" required>
                           </div>
                           </div>
						   <div class="row">
						   <div class="form-group col-md-6 col-sm-6">
                          ...
                          <input type="text" class="form1" id="pincode" placeholder="Enter Your Pincode" required>
                          </div>
						  
						  <div class="form-group col-md-6 col-sm-6">
                          <label for="pincode">D.No :</label> 
                          <input type="text" class="form1"" name="d.no" id="d.no" placeholder="Enter Your D.No" required>
                          </div>
